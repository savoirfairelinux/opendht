...
const ValueType DhtMessage::TYPE(1, "DHT message", std::chrono::minutes(5), (dht::StorePolicy&&)DhtMessage::storePolicy, (dht::EditPolicy&&)ValueType::DEFAULT_EDIT_POLICY);
const ValueType IpServiceAnnouncement::TYPE(2, "Internet Service Announcement", std::chrono::minutes(15), (dht::StorePolicy&&)IpServiceAnnouncement::storePolicy,
	(dht::EditPolicy&&)ValueType::DEFAULT_EDIT_POLICY);
