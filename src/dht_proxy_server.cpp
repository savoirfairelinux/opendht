                    ...
                    if(b.empty()) {
                        ...
                        if (reader->parse(char_data, char_data + b.size(), &root, &err)) {
                            ...
                            if (permanent) {
                                ...
                                std::cout << "permanent: pushToken " << pushToken << " clientId " << clientId << " platform " << platform << std::endl;
                                ...
                                if (r.second) {
                                    std::cout << "New ppush entry" << std::endl;
                                    ...
                                    if (not pushToken.empty()) {
                                        std::cout << "Adding refresh job" << std::endl;
                                        pput.expireNotifyJob = scheduler_.add(timeout - proxy::OP_MARGIN,
                                            [this, infoHash, vid, pushToken, clientId, isAndroid]
                                        {
                                            std::cout << "Permanent put refresh: " << infoHash << " " << std::to_string(vid) << " " << clientId << std::endl;
                                            Json::Value json;
                                            json["timeout"] = infoHash.toString();
                                            json["to"] = clientId;
                                    ...
                                    std::cout << "Refreshing put jobs" << std::endl;
