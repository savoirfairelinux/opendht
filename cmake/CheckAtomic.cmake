...
elseif(LLVM_COMPILER_IS_GCC_COMPATIBLE OR CMAKE_CXX_COMPILER_ID MATCHES "XL")
  ...
  if(NOT HAVE_CXX_ATOMICS_WITHOUT_LIB)
    ...
    if(HAVE_LIBATOMIC)
      ...
      #message(FATAL_ERROR "Host compiler appears to require libatomic, but unable to find it.")
    endif()
  endif()
endif()
...
elseif(LLVM_COMPILER_IS_GCC_COMPATIBLE OR CMAKE_CXX_COMPILER_ID MATCHES "XL")
  ...
  if(NOT HAVE_CXX_ATOMICS64_WITHOUT_LIB)
    ...
    if(HAVE_CXX_LIBATOMICS64)
      ...
      #message(FATAL_ERROR "Host compiler appears to require libatomic for 64-bit operations, but unable to find it.")
    endif()
  endif()
endif()
